...
static const int vertpadtab              = 1;    // FIXME: crashes if 0
static const int horizpadtabi            = 0;
static const int horizpadtabo            = 0;
...
static char gray1[]         = "#2e323a"; // unfocused window border
static char gray2[]         = "#545862";
...
static const char *colors[][3]      = {
    ...
    [SchemeSel]        = { black,  red,   white },
    [SchemeTitle]      = { white,  black, black }, // active window title
    [TabSel]           = { red,    black, black },
    [TabNorm]          = { gray2,  black, black },
    ...
    [SchemeBtnPrev]    = { red,    black, black },
    [SchemeBtnNext]    = { red,    black, black },
